        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('updatePost') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="body" class="form-control" name="body" required autofocus rows="10" >{{$post->body}}</textarea>
